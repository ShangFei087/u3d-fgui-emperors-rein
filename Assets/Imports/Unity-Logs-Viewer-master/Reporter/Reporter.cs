...
public class Reporter : MonoBehaviour
{
    ...
    bool isKeyDown()
    {
        ...
        {
            return (Input.GetKeyDown(KeyCode.RightControl) || Input.GetKeyDown(KeyCode.LeftControl)) && Input.GetKeyDown(KeyCode.R);
        }
        else
        {
