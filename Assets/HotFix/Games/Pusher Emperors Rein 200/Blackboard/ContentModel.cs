...
namespace PusherEmperorsRein
{
    public class ContentModel : MonoSingleton<ContentModel>, IContentModel
    {
        ...
        */
        ...
        public PageName pageName => PageName.PusherEmperorsReinPageERGameMain;
        ...
        {
            get => _isRequestToRealCreditWhenStop;
            set => _isRequestToRealCreditWhenStop = value;
        }
        public bool _isRequestToRealCreditWhenStop = false;
        ...
        */
        ...
        /// <summary> 获得游戏彩金 </summary>
        public bool isHitJackpotGame = false;
