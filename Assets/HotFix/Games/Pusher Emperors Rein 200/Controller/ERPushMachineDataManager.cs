...
namespace PusherEmperorsRein
{
    ...
    /// 【即将废弃使用】
    /// </summary>
    public class ERPushMachineDataManager : MachineDataManager
    {
        private static object _mutex = new object();
        static ERPushMachineDataManager _instance;

        public new static ERPushMachineDataManager Instance
        {
            get
            {
                ...
                lock (_mutex)
                {
                    if (_instance == null)
                    {
                        _instance = FindObjectOfType<ERPushMachineDataManager>();
                        if (_instance == null)
                        {
                            GameObject obj = new GameObject();
                            _instance = obj.AddComponent<ERPushMachineDataManager>();
        ...
        public override object[] requestFuncMock(string rpcName, object req)
        {
            ...
            DebugUtils.LogError($"【ERPushMachineDataMgr - Mock】没有实现方法：{rpcName}");
        ...
        public override object[] requestFunc(string rpcName, object req)
        {
            ...
            DebugUtils.LogError($"【ERPushMachineDataMgr - Real】没有实现方法：{rpcName}");
