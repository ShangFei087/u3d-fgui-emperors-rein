...
{
    public class PopupJackpotGameQuit : MachinePageBase
    {
        public new const string pkgName = "XingYunZhiLun_3998";
        public new const string resName = "PopupJackpotGameQuit";
        ...
        protected override void OnInit()
        {
            ...
            ResourceManager02.Instance.LoadAsset<GameObject>(
                "Assets/GameRes/Games/Xing Yun Zhi Lun 3998/Prefabs/PopupGameJackpot/PushJackpotQuit",
                (GameObject clone) =>
                {
