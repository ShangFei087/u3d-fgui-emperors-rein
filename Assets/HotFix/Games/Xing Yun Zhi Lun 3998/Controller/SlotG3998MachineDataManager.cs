...
{
    public class SlotG3998MachineDataManager : MachineDataManager
    {
        private static object _mutex = new object();
        static SlotG3998MachineDataManager _instance;

        public static SlotG3998MachineDataManager Instance
        {
            get
            {
                ...
                lock (_mutex)
                {
                    if (_instance == null)
                    {
                        _instance = FindObjectOfType<SlotG3998MachineDataManager>();
                        if (_instance == null)
                        {
                            GameObject obj = new GameObject();
                            _instance = obj.AddComponent<SlotG3998MachineDataManager>();
