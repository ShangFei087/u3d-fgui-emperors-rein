    ...
    public class FreeSpinSessionStoreG3994
{
   /// <summary>
        ...
        /// </summary>
        static string BuildKey(int playerId) => $"SlotFreeSpinSession_v{FreeSpinSessionSnapshotG3994.CurrentSessionVersion}_{GameId}_{playerId}";
        ...
        public static void TryPersistOrClearSession()
        {
            ...
            var cm = ContentModel.Instance;
            var snap = new FreeSpinSessionSnapshotG3994
            {
                PlayerId = pid,
        ...
        public static FreeSpinSessionSnapshotG3994 TryLoad(int playerId)
        {
            if (ApplicationSettings.Instance.isMock)
                return null;
            ...
            try
            {
                var snap = JsonConvert.DeserializeObject<FreeSpinSessionSnapshotG3994>(json);
                if (snap == null || snap.SessionVersion != FreeSpinSessionSnapshotG3994.CurrentSessionVersion)
                    return null;
