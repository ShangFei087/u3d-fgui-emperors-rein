...
namespace FeiZhouHeiXingXing_3994
{
    public class PopupGameLoading : MachinePageBase
    {
        ...
        private void StartPreloadGamePagesThenOpenMain()
        {
            ...
            PageName[] pages = { PageName.FeiZhouHeiXingXingPageGameMain, PageName.FeiZhouHeiXingXingPopupBigWin, PageName.FeiZhouHeiXingXingPopupSmallGameJackpotWin, PageName.FeiZhouHeiXingXingPopupFreeSpinTrigger, PageName.FeiZhouHeiXingXingPopupFreeSpinResult, PageName.FeiZhouHeiXingXingPopupSmallGameTrigger, PageName.FeiZhouHeiXingXingPopupSmallGameResult, };
