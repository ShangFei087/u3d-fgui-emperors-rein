...
namespace FeiZhouHeiXingXing_3994
{
    public class PopupSmallGameTrigger : MachinePageBase
    {
        ...
        private const string PrefabPath = "Assets/GameRes/Games/Fei Zhou Hei Xing Xing 3994/Prefabs/PopupSmallGameTrigger/";
        ...
        public override void OnOpen(PageName currentPageName, EventData eventData)
        {
            ...
            EventCenter.Instance.EventTrigger(SlotMachineEvent.ON_AUDIO_EVENT, new EventData(Game3994AudioEvent.BgmBonusTrigger));
            InitParam(eventData);
        }
