...
namespace FeiZhouHeiXingXing_3994
{
    public class PopupBigWin : MachinePageBase
    {
        ...
        private const string PagPath = "Games/Fei Zhou Hei Xing Xing 3994/Pag/PopupBigWin/";
        ...
        private readonly string[] _pagEffString = { "bigWin.pag", "superWin.pag", "megaWin.pag" };
