    ...
    public class SoundModel : MonoSingleton<SoundModel>
    {
        public Dictionary<SoundKey, GSHandler> gsHandlers = new Dictionary<SoundKey, GSHandler>
        {
            [SoundKey.RegularBG] =
                new GSHandler()
                {
                    assetPath = "Assets/GameRes/Games/Cai Fu Zhi Jia 3997/ArtRes/Sounds/Music/NormalBGM.mp3",
            ...
            [SoundKey.FreeSpinBG] =
                new GSHandler()
                {
                    assetPath = "Assets/GameRes/Games/Cai Fu Zhi Jia 3997/ArtRes/Sounds/Music/FreeBGM.mp3",
                    outputType = GSOutType.Music,
                    loop = true,
                },
            [SoundKey.JackpotBG] =
                new GSHandler()
                {
                    assetPath = "Assets/GameRes/Games/Cai Fu Zhi Jia 3997/ArtRes/Sounds/Music/JACKPOT BGM.mp3",
                    outputType = GSOutType.Music,
                    loop = true,
                },
        };
