...
{
    public class SlotG3997MachineDataManager : MachineDataManager
    {
      private static object _mutex = new object();
        static SlotG3997MachineDataManager _instance;

        public static SlotG3997MachineDataManager Instance
        {
            get
            {
                ...
                lock (_mutex)
                {
                    if (_instance == null)
                    {
                        _instance = FindObjectOfType<SlotG3997MachineDataManager>();
                        if (_instance == null)
                        {
                            GameObject obj = new GameObject();
                            _instance = obj.AddComponent<SlotG3997MachineDataManager>();
