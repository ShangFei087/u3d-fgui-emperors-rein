...
{
    /// <summary>
    /// 3997 弹窗 Spine 中英文：同一预制体 Anchor 下挂 en / cn 两套，按语言 SetActive。
    /// 必须在 Instantiate 之后、new AnimPlayer / Attach 之前调用。
    /// </summary>
    public static class PopupSpineLang3997
    {
        ...
        public static void Apply(GameObject clone)
        {
            ...
            if (en == null || cn == null)
            {
                Debug.LogError("PopupSpineLang3997: prefab missing en/cn spine under Anchor.");
                return;
            }
