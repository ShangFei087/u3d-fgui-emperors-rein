...
{
    public class SlotG3995MachineDataManager : MachineDataManager
    {
        private static object _mutex = new object();
        static SlotG3995MachineDataManager _instance;

        public static SlotG3995MachineDataManager Instance
        {
            get
            {
                ...
                lock (_mutex)
                {
                    if (_instance == null)
                    {
                        _instance = FindObjectOfType<SlotG3995MachineDataManager>();
                        if (_instance == null)
                        {
                            GameObject obj = new GameObject();
                            _instance = obj.AddComponent<SlotG3995MachineDataManager>();
