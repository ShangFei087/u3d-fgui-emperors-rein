...
namespace HuoYanGongNiu_3995
{
    ...
    public class SmallGameReelController
    {
        ...
        {
            "",
            "ui://HuoYanGongNiu_3995/ng_sym_Bonus_grand",
            "ui://HuoYanGongNiu_3995/ng_sym_Bonus_major",
            "ui://HuoYanGongNiu_3995/ng_sym_Bonus_minor",
            "ui://HuoYanGongNiu_3995/ng_sym_Bonus_mini",
        };
        ...
        public void SetRollingVisual()
        {
            ...
            foreach (SmallGameSymbol rollElement in _rollElements)
            {
                ...
                rollElement.rewardText.text =
                    iconUrl.Contains("ng_sym_Bonus_grand") ? Random.Range(0, 1000).ToString() : string.Empty;
            }
        }
        ...
        public void PlayHitRoll(float rollSpeed, float resultSpeed, Action onComplete)
        {
            ...
            _rollTrans.Play(() =>
            {
                ...
                _resultTrans.Play(() =>
                {
                    result.element.url = iconUrlList[1];
