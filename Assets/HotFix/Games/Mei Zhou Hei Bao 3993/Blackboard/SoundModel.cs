    ...
    public class SoundModel :  MonoSingleton<SoundModel>
    {
        public Dictionary<SoundKey, GSHandler> gsHandlers = new Dictionary<SoundKey, GSHandler>
        {
            [SoundKey.RegularBG] =
                new GSHandler()
                {
                    assetPath = "Assets/GameRes/Games/Mei Zhou Hei Bao 3993/ArtRes/Sounds/Music/NormalBGM.mp3",
            ...
            [SoundKey.FreeSpinBG] =
                new GSHandler()
                {
                    assetPath = "Assets/GameRes/Games/Mei Zhou Hei Bao 3993/ArtRes/Sounds/Music/FreeBGM.mp3",
                    outputType = GSOutType.Music,
                    loop = true,
                },
            [SoundKey.JackpotBG] =
                new GSHandler()
                {
                    assetPath = "Assets/GameRes/Games/Mei Zhou Hei Bao 3993/ArtRes/Sounds/Music/BonusBGM.mp3",
                    outputType = GSOutType.Music,
                    loop = true,
                },
        };
