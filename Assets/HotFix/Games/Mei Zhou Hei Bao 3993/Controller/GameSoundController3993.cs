...
{
    public static class Game3993AudioEvent
    {
        /// <summary> 主游戏循环 BGM </summary>
        public const string BgmRegularGame = "3993_BgmRegularGame";

        /// <summary> 免费局内循环 BGM </summary>
        public const string BgmFreeSpinGame = "3993_BgmFreeSpinGame";

        /// <summary> 彩金小游戏局内循环 BGM </summary>
        public const string BgmBonusGame = "3993_BgmBonusGame";

        /// <summary> 免费触发弹窗 BGM </summary>
        public const string BgmFreeSpinTrigger = "3993_BgmFreeSpinTrigger";

        /// <summary> 免费结算弹窗 BGM </summary>
        public const string BgmFreeSpinResult = "3993_BgmFreeSpinResult";

        /// <summary> 彩金触发弹窗 BGM </summary>
        public const string BgmBonusTrigger = "3993_BgmBonusTrigger";

        /// <summary> 彩金结算弹窗 BGM </summary>
        public const string BgmBonusResult = "3993_BgmBonusResult";
    }
    ...
    public class GameSoundController3993
    {
        ...
        public GameSoundController3993()
        {
            Init();
        }
        ...
        private void PlayScatterBonusColumnStopSoundsFromFlags(int column0Based, bool hasScatter, bool hasBonus)
        {
            ...
            if (hasScatter)
                GameSoundHelper3993.Instance.PlaySoundEff(SoundKey.ScatterDown);
            ...
            switch ((string)receivedEvent.name)
            {
                case SlotMachineEvent.SpinSlotMachine:
                    ...
                    if (ContentModel.Instance.isSmallGameSpin)
                        ...
                        GameSoundHelper3993.Instance.PlaySoundEff(SoundKey.NormalRolling);
                    break;
                case SlotMachineEvent.StoppedSlotMachine:
                    ...
                    if (GameSoundHelper3993.Instance.IsPlaySound(SoundKey.FreeRollingBox)) GameSoundHelper3993.Instance.StopSound(SoundKey.FreeRollingBox);
                    if (GameSoundHelper3993.Instance.IsPlaySound(SoundKey.BonusRollingBox)) GameSoundHelper3993.Instance.StopSound(SoundKey.BonusRollingBox);
                    break;
            }
        }
        ...
        private void OnSlotDetailEvent(EventData receivedEvent)
        {
            ...
            if (name == SlotMachineEvent.ReelColumnStopSound)
            {
                ...
                GameSoundHelper3993.Instance.PlaySoundEff(key);
                return;
            }
        ...
        private void OnAudioEvent(EventData receivedEvent)
        {
            switch ((string)receivedEvent.name)
            {
                case SlotMachineEvent.FreeGameFadeTransition:
                    GameSoundHelper3993.Instance.PlaySoundEff(SoundKey.FadeFree);
                    break;
                case SlotMachineEvent.BonusGameFadeTransition:
                    GameSoundHelper3993.Instance.PlaySoundEff(SoundKey.FadeBonus);
                    break;
                case SlotMachineEvent.FreeSpinPopupAppear:
                    GameSoundHelper3993.Instance.PlaySoundEff(SoundKey.FreePopupAppear);
                    break;
                case SlotMachineEvent.FreeSpinPopupDisappear:
                    GameSoundHelper3993.Instance.PlaySoundEff(SoundKey.FreePopupDisappear);
                    break;
                case SlotMachineEvent.FreeSpinStartButtonShown:
                    GameSoundHelper3993.Instance.PlaySoundEff(SoundKey.FreeStartBtn);
                    break;
                case SlotMachineEvent.JackpotPopupAppear:
                    GameSoundHelper3993.Instance.PlaySoundEff(SoundKey.JackpotPopupAppear);
                    break;
                case SlotMachineEvent.JackpotPopupDisappear:
                    GameSoundHelper3993.Instance.PlaySoundEff(SoundKey.JackpotPopupDisappear);
                    break;
                case SlotMachineEvent.BonusPopupAppear:
                    GameSoundHelper3993.Instance.PlaySoundEff(SoundKey.BonusPopupAppear);
                    break;
                case SlotMachineEvent.BonusStartBtn:
                    GameSoundHelper3993.Instance.PlaySoundEff(SoundKey.BonusStartBtn);
                    break;
                case SlotMachineEvent.BonusPopupDisappear:
                    GameSoundHelper3993.Instance.PlaySoundEff(SoundKey.BonusPopupDisappear);
                    break;
                case SlotMachineEvent.BonusCollectBtn:
                    GameSoundHelper3993.Instance.PlaySoundEff(SoundKey.BonusCollectBtn);
                    break;
                case SlotMachineEvent.FreeRollingBox:
                    // 同轨叠播前先停，避免拖音
                    if (GameSoundHelper3993.Instance.IsPlaySound(SoundKey.FreeRollingBox))
                        GameSoundHelper3993.Instance.StopSound(SoundKey.FreeRollingBox);
                    GameSoundHelper3993.Instance.PlaySoundEff(SoundKey.FreeRollingBox);
                    break;
                case SlotMachineEvent.BonusRollingBox:
                    if (GameSoundHelper3993.Instance.IsPlaySound(SoundKey.BonusRollingBox))
                        GameSoundHelper3993.Instance.StopSound(SoundKey.BonusRollingBox);
                    GameSoundHelper3993.Instance.PlaySoundEff(SoundKey.BonusRollingBox);
                    break;
                case Game3993AudioEvent.BgmRegularGame:
                    GameSoundHelper3993.Instance.PlayMusicSingle(SoundKey.RegularBG);
                    break;
                case Game3993AudioEvent.BgmFreeSpinGame:
                    GameSoundHelper3993.Instance.PlayMusicSingle(SoundKey.FreeSpinBG);
                    break;
                case Game3993AudioEvent.BgmBonusGame:
                    GameSoundHelper3993.Instance.PlayMusicSingle(SoundKey.BonusBG);
                    break;
                case Game3993AudioEvent.BgmFreeSpinTrigger:
                    GameSoundHelper3993.Instance.PlayMusicSingle(SoundKey.FreeSpinTriggerBG);
                    break;
                case Game3993AudioEvent.BgmFreeSpinResult:
                    GameSoundHelper3993.Instance.PlayMusicSingle(SoundKey.FreeSpinResultBG);
                    break;
                case Game3993AudioEvent.BgmBonusTrigger:
                    GameSoundHelper3993.Instance.PlayMusicSingle(SoundKey.BonusTriggerBG);
                    break;
                case Game3993AudioEvent.BgmBonusResult:
                    GameSoundHelper3993.Instance.PlayMusicSingle(SoundKey.BonusResultBG);
                    break;
            }
        }
        ...
        private void OnTotalWinCreditForWinLevel(EventData receivedEvent)
        {
            ...
            if (totalBet <= 0)
            {
                GameSoundHelper3993.Instance.PlaySoundEff(SoundKey.win_lv1);
                return;
            }

            // ≥3 倍押注高档，≥2 倍中档，否则低档
            if (winCredit >= 3L * totalBet)
                GameSoundHelper3993.Instance.PlaySoundEff(SoundKey.win_lv3);
            else if (winCredit >= 2L * totalBet)
                GameSoundHelper3993.Instance.PlaySoundEff(SoundKey.win_lv2);
            else
                GameSoundHelper3993.Instance.PlaySoundEff(SoundKey.win_lv1);
        }
        ...
        private void TryPlayScatterWinSound()
        {
            ...
            GameSoundHelper3993.Instance.PlaySoundEff(SoundKey.ScatterWin);
        }
