...
namespace SlotZhuZaiJinBi1700
{
    public static class FreeSpinSessionStoreG1700
    {
        ...
        /// </summary>
        static string BuildKey(int playerId) => $"SlotFreeSpinSession_v{FreeSpinSessionSnapshotG1700.CurrentSessionVersion}_{GameId}_{playerId}";
        ...
        public static void TryPersistOrClearSession()
        {
            ...
            var cm = ContentModel.Instance;
            var snap = new FreeSpinSessionSnapshotG1700
            {
                PlayerId = pid,
        ...
        public static FreeSpinSessionSnapshotG1700 TryLoad(int playerId)
        {
            if (ApplicationSettings.Instance.isMock)
                return null;
            ...
            try
            {
                var snap = JsonConvert.DeserializeObject<FreeSpinSessionSnapshotG1700>(json);
                if (snap == null || snap.SessionVersion != FreeSpinSessionSnapshotG1700.CurrentSessionVersion)
                    return null;
