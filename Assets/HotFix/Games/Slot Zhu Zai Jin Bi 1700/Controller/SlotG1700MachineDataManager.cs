...
{
    public class SlotG1700MachineDataManager : MachineDataManager
    {
        private static object _mutex = new object();
        static SlotG1700MachineDataManager _instance;

        public static SlotG1700MachineDataManager Instance
        {
            get
            {
                ...
                lock (_mutex)
                {
                    if (_instance == null)
                    {
                        _instance = FindObjectOfType<SlotG1700MachineDataManager>();
                        if (_instance == null)
                        {
                            GameObject obj = new GameObject();
                            _instance = obj.AddComponent<SlotG1700MachineDataManager>();
