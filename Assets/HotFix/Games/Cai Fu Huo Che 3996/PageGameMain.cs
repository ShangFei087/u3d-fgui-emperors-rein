...
namespace CaiFuHuoChe_3996
{
    ...
    public class PageGameMain : MachinePageBase //: PageBase
    {
        ...
        //免费游戏以及彩金游戏中特殊奖时特效
        private GameObject goRewardEffectPre, goRewardEffectObj1, goRewardEffectObj2, goRewardEffectObj3, goMoneyBoxEff;
        ...
        private IEnumerator GameOnce(Action successCallback, Action<string> errorCallback)
        {
            ...
            if (ContentModel.Instance.isFreeSpinTrigger)
            {
                ...
                //积分同步和退币处理
                slotMachineCtrl.SendTotalWinCreditEvent(ContentModel.Instance.freeSpinTotalWinCredit + tempCredit);
            }
        ...
        private void SetFreeTrainState(bool isFreeChange = false)
        {
