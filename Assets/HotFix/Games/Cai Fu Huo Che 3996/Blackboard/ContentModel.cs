...
namespace CaiFuHuoChe_3996
{
    public class ContentModel : MonoSingleton<ContentModel>, IContentModel
    {
        ...
        public bool wheelIsSpin
        {
            get => _wheelIsSpin;
            set => _wheelIsSpin = value;
        }
        public bool _wheelIsSpin;
        ...
        /// <summary> 彩金游戏结束 </summary>
        public bool isJackpotSpinResult;

        /// <summary> 是否包含彩金奖励 </summary>
        public bool haveJackpotCredit = false;
        ...
        public bool isJackpotSpin => curReelStripsIndex == "JS";
        ...
        /// <summary> 当前彩金游戏轮数  </summary>
        public int jackpotSpinPlayTimes
        {
            get => m_JackpotSpinPlayTimes;
            set => observable.SetProperty(ref m_JackpotSpinPlayTimes, value);
        }
        ...
        {
            get => m_JackpotSpinTotalTimes;
            set => observable.SetProperty(ref m_JackpotSpinTotalTimes, value);
        }
        private int m_JackpotSpinTotalTimes = 0;

        /// <summary> 彩金游戏单次获得  </summary>
        public int jackpotSpinWinCredit
        {
            get => m_JackpotSpinWinCredit;
            set => observable.SetProperty(ref m_JackpotSpinWinCredit, value);
        }
        private int m_JackpotSpinWinCredit = 0;


        /// <summary>
        /// 彩金游戏显示剩余多少次
        /// </summary>
        public int showJackpotSpinRemainTime
        {
            get => m_showJackpotSpinRemainTime;
            set => observable.SetProperty(ref m_showJackpotSpinRemainTime, value);
        }
        public int m_showJackpotSpinRemainTime = 0;
        ...
        /// <summary> wheelBtnSpinState 按钮状态 </summary>
        public string wheelBtnSpinState
        {
            get => m_WheelBtnSpinState;
            set => observable.SetProperty(ref m_WheelBtnSpinState, value);
        }
        [SerializeField]
        private string m_WheelBtnSpinState = "Stop";
        ...
        {
            get => m_curBtnSpinState;
            set => observable.SetProperty(ref m_curBtnSpinState, value);
        }
        [SerializeField]
