...
namespace CaiFuHuoChe_3996
{
    ...
    public class MockDataG3996Controller : MonoSingleton<MockDataG3996Controller>
    {
        ...
        public void ParseSlotSpin(long totalBet, JSONNode res)
        {
            ...
            string bonusType = res["contents"]["bonus_type"];
            ...
            ContentModel.Instance.bonusType = bonusType;
            try
            {
                // 为null时，使用上次的数值
            ...
            bool isReelsSlowMotion = ((deckColRow[0].Contains(10) && deckColRow[1].Contains(10)) || (deckColRow[0].Contains(11) && deckColRow[1].Contains(11))) ? true : false;
        ...
        private Dictionary<SpinDataType, List<string[]>> spinDatas = new Dictionary<SpinDataType, List<string[]>>()
        {
            [SpinDataType.FreeSpin] = new List<string[]>()
            {
               new string[]
                {
                    "Assets/HotFix/Games/_Mock/Resources/g1700/g1700__slot_spin__00.json",
                    "Assets/HotFix/Games/_Mock/Resources/g1700/g1700__slot_spin__free_spin__1.json",
                    "Assets/HotFix/Games/_Mock/Resources/g1700/g1700__slot_spin__free_spin__2.json",
                    "Assets/HotFix/Games/_Mock/Resources/g1700/g1700__slot_spin__free_spin__3.json",

                },
            },
            [SpinDataType.Normal] = new List<string[]>()
            {
                 //new string[] { "Assets/HotFix/Games/_Mock/Resources/g1700/g1700__slot_spin__0.json" },
                 new string[] { "Assets/HotFix/Games/_Mock/Resources/g1700/g1700__slot_spin__1.json" },
                // new string[] { "Assets/HotFix/Games/_Mock/Resources/g1700/g1700__slot_spin__2.json" },
                 //new string[] { "Assets/HotFix/Games/_Mock/Resources/g1700/g1700__slot_spin__3.json" },
            },
            [SpinDataType.BigWin] = new List<string[]>()
            {
                new string[] { "Assets/HotFix/Games/_Mock/Resources/g1700/1700__slot_spin__1.json" },
            },
            [SpinDataType.Jp1] = new List<string[]>()
            {
                new string[] { "Assets/HotFix/Games/_Mock/Resources/g1700/g1700__slot_spin__jackpot_grand.json" },
            },
            [SpinDataType.Jp2] = new List<string[]>()
            {
                new string[] { "Assets/HotFix/Games/_Mock/Resources/g1700/g1700__slot_spin__jackpot_major.json" },
            },
            [SpinDataType.Jp3] = new List<string[]>()
            {
                new string[] { "Assets/HotFix/Games/_Mock/Resources/g1700/g1700__slot_spin__jackpot_mini.json" },
            },
            [SpinDataType.Jp4] = new List<string[]>()
            {
                new string[] { "Assets/HotFix/Games/_Mock/Resources/g1700/g1700__slot_spin__jackpot_minor.json" },
            }
        };

        Queue<string> curDatas = new Queue<string>();

        /*totalBet: 总投注金额（虽然方法中未直接使用，但可能用于后续处理）
        successCallback: 成功回调，返回解析后的 JSON 数据
        errorCallback: 错误回调，返回错误信息*/
            ...
            Action<BagelCodeError> errorCallback)
        {
            ...
            Timer.DelayAction(0.2f, () =>
            {
                if (curDatas.Count == 0)
                {
                    List<string[]> target = null; // 选普通游戏 还是免费游戏
                    Debug.LogError(nextSpin);
